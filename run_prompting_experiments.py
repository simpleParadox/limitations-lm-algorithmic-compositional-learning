...
from prompting_experiment_utils.prompt_builder_pen import build_prompt as build_prompt_pen
from prompting_experiment_utils.prompt_builder_perm import build_prompt as build_prompt_perm
from prompting_experiment_utils.prompt_llm import generate_text
from data_modules.synthetic_tasks import PointerExecutionNeighbour, PointerExecutionReverseMulticount
import os


@hydra.main(config_path="configs", config_name="experiment_cfg_prompting", version_base=None)
...
def make_experiment(exp_cfg, cfg_pen, cfg_perm, full_cfg):
    ...
    llm_answer = generate_text(prompt, credentials=full_cfg, with_code=with_code, model=full_cfg['model_name'])
